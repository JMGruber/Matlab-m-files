...
readdir='H:\Personal\Matlab m-files\some data to play with\Palustris spectra';
writedir='H:\Personal\Matlab m-files\some data to play with\test spectra';
...
fwhm=35; 
skewness=0.1;
peak2=800; peak1=950; %typical peak positions for double-band spectra;

% boundary conditions for fitting
xmin=600; xmax=950; % maximum wavelength window considered in all calculations. Set 0 if full range is requireed.
Qthr=300; % if intensity is below this threshold, chances are good for a misfit. 
...
minwavint=800; maxwavint=900; %wavelengths considered together with deadthr. Should be within (xmin,xmax)
...
peakmin=790; peakmax=900;
fwhmmin=25; fwhmmax=55;
